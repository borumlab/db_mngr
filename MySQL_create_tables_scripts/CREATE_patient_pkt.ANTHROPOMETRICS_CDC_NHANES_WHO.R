...
NHANES <- read.csv('ANTHROPOMETRICS_NHANES_REFERENCES_SOURCE_08012016.txt', header=TRUE, sep="\t", na.strings=c("","NA"))
...
dbWriteTable(connect,value=NHANES,name="ANTHROPOMETRICS_NHANES_REFERENCES_SOURCE_08012016",append=TRUE)
